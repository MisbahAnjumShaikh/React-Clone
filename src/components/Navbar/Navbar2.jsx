        ...
        <div className="container-fluid">
          <span>
            <a className="navbar-brand" href={"https://react.dev/"}>
              <img src={logo} className="logo img-fluid" alt={"React"} />
            </a>
          </span>
          <span>
            <a href={"https://react.dev/versions"} className="v19 fw-medium">
              v19
            </a>
          </span>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="nav-menu navbar-nav me-auto mb-2 mb-lg-0 gap-3 fw-medium">
              <li className="nav-item">
                <a
                  className="nav-link links px-3 rounded-pill"
                  aria-current="page"
              ...
              <li className="nav-item">
                <a
                  className="nav-link links rounded-pill "
              ...
              <li className="nav-item">
                <a
                  ...
                  href={"https://react.dev/community/translations"}
                >
